    ...
    public function show(Request $request, Task $task)
    {
        ...
        return Inertia::render('Tasks/Show', [
            'task' => [
                ...
                'due_label'    => $task->due_date ? $task->due_date->locale : null('es')->isoFormat('dddd D [de] MMMM'),
                'is_overdue'   => $task->due_date && $task->due_date->isPast() && $task->status !== 'done',
                'completed_at' => $task->completed_at ? $task->completed_at->locale : null('es')->isoFormat('D MMM YYYY, HH:mm'),
