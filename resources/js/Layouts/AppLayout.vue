            ...
            <div class="border-t border-gray-700/50 px-3 py-3">
                <div class="flex items-center gap-3 rounded-lg px-2 py-2">
                    ...
                    <Link href="/profile"
                        ...
                        title="Perfil"
                        class="p-1 text-gray-500 dark:text-gray-400 hover:text-white transition-colors rounded focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-blue-400">
